...
//          //Blockly.Blocks={};
//
//goog.provide('Blockly.Blocks.bi_maps');
//
...
Blockly.Blocks['bi_maps_create_with'] = {
  ...
  init: function() {
    ...
    this.setColour(Blockly.Msg["MAPS_HUE"]); //(Blockly.Msg["MAP_HUE"]);
    this.itemCount_ = 1;
...
Blockly.Blocks['maps_create_with'] = {
  ...
  init: function() {
    ...
    //     .appendField("");
    this.setHelpUrl(Blockly.Msg.MAPS_CREATE_WITH_HELPURL);
    this.setColour(Blockly.Msg["MAPS_HUE"]);
...
Blockly.Blocks['maps_length'] = {
  ...
  init: function() {
    this.jsonInit({
  "id": "maps_length",
  // JCOA: Fix this to use messages maps
  "message0": "size of %1", //Blockly.Msg.MAPS_LENGTH_TITLE,
  "args0": [
    {
      "type": "input_value",
      "name": "MAP",
...
Blockly.Blocks['maps_isempty'] = {
  ...
  init: function() {
    this.jsonInit({
  "id": "maps_isempty",
  "message0": "%1 is empty", //Blockly.Msg.MAPS_ISEMPTY_TITLE,
  "args0": [
    {
      "type": "input_value",
      "name": "MAP",
...
Blockly.Blocks['maps_create'] = {
  ...
  init: function() {
    this.jsonInit({
  "id": "maps_create",
  "message0": "map key %1 as %2", //Blockly.Msg.MAPS_CREATE_TITLE,
  "args0": [
    {
      "type": "input_value",
      "name": "KEY",
...
Blockly.Blocks['maps_getIndex'] = {
  ...
  init: function() {
    this.jsonInit({
  "id": "maps_getIndex",
  "message0": "in map %1 %2 %3", // Blockly.Msg.MAPS_GET_INDEX_INPUT_IN_MAP + "%1 %2 %3",
  "args0": [
    {
      "type": "input_value",
      "name": "MAP",
...
Blockly.Blocks['maps_setIndex'] = {
  ...
  init: function() {
    this.jsonInit({
  "id": "maps_setindex",
  "message0": "in map %1 set %2 as %3", //Blockly.Msg.MAPS_SET_INDEX_INPUT_IN_MAP + "%1" +
...
Blockly.Blocks['maps_keys'] = {
  ...
  init: function() {
    this.jsonInit({
  "id": "maps_keys",
  "message0": "get keys of %1", //Blockly.Msg.MAPS_KEYS_TITLE,
  "args0": [
    {
      "type": "input_value",
      "name": "MAP",
